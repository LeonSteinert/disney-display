...
try:
    ...
    draw.text((20, 35), 'SSID: "Winnie Puuh Display"', font = font18, fill = 0)
    draw.text((20, 55), 'Passwort: 987654321', font = font18, fill = 0)
    draw.text((20, 75), 'IP-Adresse: 10.42.0.1', font = font18, fill = 0)
